...
export const REGIONS: Region[] = [
  ...
  // ─── 서울 나머지 21구 (2026.04 전 구 OTHER_REGULATED 격상) ───
  { code: '11110', name: '종로구',     province: '서울', regulation: 'OTHER_REGULATED' },
  { code: '11140', name: '중구',       province: '서울', regulation: 'OTHER_REGULATED' },
  { code: '11200', name: '성동구',     province: '서울', regulation: 'OTHER_REGULATED' },
  { code: '11215', name: '광진구',     province: '서울', regulation: 'OTHER_REGULATED' },
  { code: '11230', name: '동대문구',   province: '서울', regulation: 'OTHER_REGULATED' },
  { code: '11260', name: '중랑구',     province: '서울', regulation: 'OTHER_REGULATED' },
  { code: '11290', name: '성북구',     province: '서울', regulation: 'OTHER_REGULATED' },
  { code: '11350', name: '노원구',     province: '서울', regulation: 'OTHER_REGULATED' },
  { code: '11380', name: '은평구',     province: '서울', regulation: 'OTHER_REGULATED' },
  { code: '11410', name: '서대문구',   province: '서울', regulation: 'OTHER_REGULATED' },
  { code: '11470', name: '양천구',     province: '서울', regulation: 'OTHER_REGULATED' },
  { code: '11500', name: '강서구',     province: '서울', regulation: 'OTHER_REGULATED' },
  { code: '11545', name: '금천구',     province: '서울', regulation: 'OTHER_REGULATED' },
  { code: '11620', name: '관악구',     province: '서울', regulation: 'OTHER_REGULATED' },
  { code: '11740', name: '강동구',     province: '서울', regulation: 'OTHER_REGULATED' },
